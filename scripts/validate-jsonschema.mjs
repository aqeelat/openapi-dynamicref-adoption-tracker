...
const cases = [
  ...
  {
    name: 'allOf generic binding: valid asset page (AJV currently fails this pattern)',
    fixture: 'allOf-generic-binding.yaml',
    schema: 'AssetPaged',
    data: { content: [{ id: 'a1', name: 'Logo' }], total_elements: 1, total_pages: 1 },
    expected: false,
    knownGap: true,
  },
  {
    name: 'allOf generic binding: invalid asset item',
    fixture: 'allOf-generic-binding.yaml',
    schema: 'AssetPaged',
    data: { content: [{ id: 'a1', label: 'Not an asset' }], total_elements: 1, total_pages: 1 },
    expected: false,
  },
  {
    name: 'allOf generic binding: valid group page (AJV currently fails this pattern)',
    fixture: 'allOf-generic-binding.yaml',
    schema: 'GroupPaged',
    data: { content: [{ id: 'g1', label: 'Admins' }], total_elements: 1, total_pages: 1 },
    expected: false,
    knownGap: true,
  },
  {
    name: 'allOf generic binding: invalid group item',
    fixture: 'allOf-generic-binding.yaml',
    schema: 'GroupPaged',
    data: { content: [{ id: 'g1', name: 'Not a group' }], total_elements: 1, total_pages: 1 },
    expected: false,
  },
  {
...
const hyperjumpCases = [
  ...
  {
    name: 'hyperjump allOf generic binding: valid asset page',
    fixture: 'allOf-generic-binding.yaml',
    schema: 'AssetPaged',
    data: { content: [{ id: 'a1', name: 'Logo' }], total_elements: 1, total_pages: 1 },
    expected: true,
  ...
  {
    name: 'hyperjump allOf generic binding: invalid asset item',
    fixture: 'allOf-generic-binding.yaml',
    schema: 'AssetPaged',
    data: { content: [{ id: 'a1', label: 'Not an asset' }], total_elements: 1, total_pages: 1 },
    expected: false,
  ...
  {
    name: 'hyperjump allOf generic binding: valid group page',
    fixture: 'allOf-generic-binding.yaml',
    schema: 'GroupPaged',
    data: { content: [{ id: 'g1', label: 'Admins' }], total_elements: 1, total_pages: 1 },
    expected: true,
  ...
  {
    name: 'hyperjump allOf generic binding: invalid group item',
    fixture: 'allOf-generic-binding.yaml',
    schema: 'GroupPaged',
    data: { content: [{ id: 'g1', name: 'Not a group' }], total_elements: 1, total_pages: 1 },
    expected: false,
